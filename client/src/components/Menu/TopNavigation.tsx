...
export const TopNavigation: React.FC<TopNavigationProps> = ({ title, menuHandler }) => (
    <div className="flex flex-row items-center bg-gray-700 py-4 px-4">
        <IoMenu onClick={() => menuHandler((prev: boolean) => !prev)} color="#F2F2F2" size="2.2rem" cursor="pointer" />
